      ...
      <el-card>
        <div class="flex w-full flex-col gap-4 md:flex-row">
          ...
          <div class="mt-0.5">
            ...
            <el-button type="primary" link :disabled="data.status === 'Installing'" @click="onOperate('restart')">
              {{ $t('app.restart') }}
            </el-button>
            <el-divider direction="vertical" />
            <el-button
            ...
            <el-button
              ...
              @click="setting"
              link
              :disabled="data.status === 'Installing' || (data.status !== 'Running' && data.app === 'OpenResty')"
            >
