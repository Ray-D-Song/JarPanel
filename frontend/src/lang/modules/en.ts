...
const message = {
  commons: {
    ...
    rule: {
      ...
      commonName: 'Supports non-special characters starting with English, Chinese, numbers, .- and _, length 1-128',
      ...
      dbName:
        'Supports non-special character starting, including English, Chinese, numbers, .-_, with a length of 1-64',
      ...
      mirror:
        'The mirror acceleration address should start with http(s)://, support English letters (both uppercase and lowercase), numbers, . / and -, and should not contain blank lines.',
  ...
  container: {
    ...
    down: 'Down',
    up: 'Up',
    composeDetailHelper: 'The compose is created external to 1Panel. The start and stop operations are not supported.',
  ...
  toolbox: {
    ...
    device: {
      ...
      userHelper: 'The username depends on the whoami command for retrieval. If not installed, retrieval may fail.',
      passwordHelper:
        'Password modification depends on the chpasswd command. If not installed, the modification may fail.',
      hostHelper: 'There is an empty value in the provided content. Please check and try again after modification!',
    ...
    ftp: {
      ...
      enableHelper: 'Enabling the selected FTP account will restore its access permissions. Do you want to continue?',
      disableHelper: 'Disabling the selected FTP account will revoke its access permissions. Do you want to continue?',
  ...
  file: {
    ...
    deleteHelper2: 'Are you sure you want to delete the selected file? The deletion operation cannot be rolled back',
  ...
  setting: {
    ...
    titleHelper: 'Supports non-special character starting, English, Chinese, numbers, spaces, .- and _, length 3-30',
    portHelper:
    ...
    sessionTimeoutHelper: 'If you do not operate the panel for more than {0} seconds, the panel automatically logs out',
    ...
    unSetting: 'Unset',
    noneSetting: 'Set the expiration time for the panel password. After the expiration, you need to reset the password',
    ...
    unBindDomainHelper: 'The action of unbinding a domain name may cause system insecurity. Do you want to continue?',
    bindDomainHelper: 'After the domain binding, only the domain in the setting can be used to access 1Panel service',
    ...
    recoverHelper: 'Starting recovery from snapshot {0}, please confirm the following information before proceeding:',
    ...
    showMainAdvancedMenu: 'If only one menu is retained, only the main advanced menu will be displayed in the sidebar',
    showAll: 'Show All',
    hideALL: 'Hide All',
  ...
  license: {
    ...
    alert:
      'Upgrade to the professional version to receive alarm information via SMS and view alarm logs, fully control various key events, and ensure worry-free system operation',
  },
  clean: {
    scan: 'Start Scanning',
  ...
  app: {
    ...
    downloadLogHelper2: 'The latest {1} logs of {0} application are about to be downloaded. Do you want to continue? ',
  ...
  runtime: {
    ...
    javaScriptHelper: 'Please fill in the complete startup command, for example: java -jar halo.jar -Xmx1024M -Xms256M',
  ...
  tool: {
    supervisor: {
      ...
      restartHelper: 'Initialization will restart the service, causing all the original daemon processes to close',
      msg: 'Message',
      RUNNING: 'Running',
      STOPPED: 'Stopped',
      STOPPING: 'Stopping',
