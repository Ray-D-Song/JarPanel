    ...
    <div class="app-status p-mt-20">
      <el-card>
        <div>
          ...
          <el-tag v-if="dialogData.rowData.path.length < 35" class="float-left ml-5" effect="dark" type="success">
          ...
          <el-row :gutter="20" v-show="hasRecords" class="mainRowClass">
            <el-col :span="7">
              <div class="infinite-list" style="overflow: auto">
                <el-table style="cursor: pointer" :data="records" border :show-header="false" @row-click="clickRow">
                  <el-table-column>
            ...
            <el-col :span="17">
              <el-form label-position="top" :v-key="refresh">
                ...
                <el-row>
                  <el-select class="descriptionWide" @change="search" v-model.number="searchInfo.tail">
