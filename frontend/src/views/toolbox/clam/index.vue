<template>
  <div>
    <LayoutContent v-loading="loading" v-if="!isRecordShow && !isSettingShow" :title="$t('toolbox.clam.clam')">
      ...
      <template #app>
        <ClamStatus @setting="setting" v-model:loading="loading" @get-status="getStatus" v-model:mask-show="maskShow" />
      </template>
      ...
      <template #main v-if="clamStatus.isExist">
        ...
        >
          ...
          <el-table-column :label="$t('commons.table.name')" :min-width="60" prop="name" sortable show-overflow-tooltip>
          ...
          <el-table-column :label="$t('toolbox.clam.scanDir')" :min-width="120" prop="path" show-overflow-tooltip>
            <template #default="{ row }">
          ...
          <el-table-column v-if="isProductPro" :label="$t('cronjob.cronSpec')" show-overflow-tooltip :min-width="120">
            <template #default="{ row }">
              <span>
          ...
          <el-table-column :label="$t('toolbox.clam.infectedDir')" :min-width="120" prop="path" show-overflow-tooltip>
            <template #default="{ row }">
              <el-button
