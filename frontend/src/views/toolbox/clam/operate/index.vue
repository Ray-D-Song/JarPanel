      ...
      <el-row type="flex" justify="center">
        <el-col :span="22">
          ...
          <el-form-item prop="spec" v-if="dialogData.rowData!.hasSpec && isProductPro">
            <el-select class="specTypeClass" v-model="dialogData.rowData!.specObj.specType" @change="changeSpecType()">
...
const hasInfectedDir = () => {
  return dialogData.value.rowData!.infectedStrategy === 'move' || dialogData.value.rowData!.infectedStrategy === 'copy';
};
  ...
  formEl.validate(async (valid) => {
    ...
    if (dialogData.value.rowData!.hasAlert) {
      dialogData.value.rowData.alertCount = dialogData.value.rowData!.hasAlert
        ...
        : 0;
      dialogData.value.rowData.alertTitle = i18n.global.t('toolbox.clam.alertTitle', [dialogData.value.rowData.name]);
    } else {
