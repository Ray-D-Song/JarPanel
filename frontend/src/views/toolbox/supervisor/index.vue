      ...
      <template #main v-if="showTable">
        <ComplexTable :data="data" :class="{ mask: !supervisorStatus.isRunning }" v-loading="dataLoading">
          ...
          <el-table-column
            ...
            show-overflow-tooltip
          ></el-table-column>
          <el-table-column :label="$t('tool.supervisor.dir')" prop="dir" min-width="100px" fix show-overflow-tooltip>
          ...
          <el-table-column
            ...
            min-width="50px"
          ></el-table-column>
          <el-table-column :label="$t('tool.supervisor.numprocs')" prop="numprocs" min-width="60px"></el-table-column>
              ...
              <div v-if="row.hasLoad">
                <el-popover placement="bottom" :width="600" trigger="hover">
                  ...
                  <el-table :data="row.status">
                    <el-table-column property="name" :label="$t('commons.table.name')" fix show-overflow-tooltip />
                    <el-table-column property="status" :label="$t('tool.supervisor.statusCode')" width="100px" />
                    <el-table-column property="PID" label="PID" width="100px" />
                    <el-table-column property="uptime" :label="$t('tool.supervisor.uptime')" width="100px" />
                    <el-table-column property="msg" :label="$t('tool.supervisor.msg')" fix show-overflow-tooltip />
                  </el-table>
                </el-popover>
              </div>
              <div v-if="!row.hasLoad">
