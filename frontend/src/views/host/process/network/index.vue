    ...
    <LayoutContent :title="$t('menu.network')" v-loading="loading">
      <template #toolbar>
        <div class="flex justify-between gap-2 flex-wrap sm:flex-row">
          ...
          <div class="flex flex-wrap gap-3">
            <TableSearch @search="search()" :placeholder="$t('process.pid')" v-model:searchName="netSearch.processID" />
      ...
      <template #main>
        <ComplexTable :data="data" @sort-change="changeSort" @filter-change="changeFilter" ref="tableRef">
          ...
          <el-table-column :label="$t('process.processName')" fix prop="name" min-width="120px"></el-table-column>
