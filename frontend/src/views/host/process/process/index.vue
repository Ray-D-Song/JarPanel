    ...
    <LayoutContent :title="$t('menu.process')" v-loading="loading">
      <template #toolbar>
        <div class="flex justify-between gap-2 flex-wrap sm:flex-row">
          ...
          <div class="flex flex-wrap gap-3">
            <TableSearch @search="search()" :placeholder="$t('process.pid')" v-model:searchName="processSearch.pid" />
      ...
      <template #main>
        <ComplexTable :data="data" @sort-change="changeSort" @filter-change="changeFilter" ref="tableRef">
          ...
          <el-table-column :label="$t('commons.table.name')" fix prop="name" min-width="120px"></el-table-column>
          <el-table-column :label="$t('process.ppid')" min-width="120px" fix prop="PPID" sortable></el-table-column>
          ...
          <el-table-column :label="'CPU'" fix prop="cpuValue" :formatter="cpuFormatter" sortable></el-table-column>
          <el-table-column
          ...
          <el-table-column :label="$t('process.startTime')" fix prop="startTime" min-width="140px"></el-table-column>
