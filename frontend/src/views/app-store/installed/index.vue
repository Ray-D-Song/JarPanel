              ...
              <el-row :gutter="20">
                <el-col :xs="3" :sm="3" :md="3" :lg="4" :xl="4">
                  <div class="icon" @click.stop="openDetail(installed.appKey)">
                    <el-avatar shape="square" :size="66" :src="'data:image/png;base64,' + installed.icon" />
                  </div>
                </el-col>
                <el-col :xs="24" :sm="21" :md="21" :lg="20" :xl="20">
                  <div class="a-detail">
                    <div class="d-name">
                      ...
                      <span class="ml-1">
                        <el-tooltip effect="dark" :content="$t('commons.button.log')" placement="top">
                          <el-button
                            type="primary"
                            link
                    ...
                    <div class="d-description">
                      ...
                      <div class="description">
                        <span>{{ $t('app.alreadyRun') }}： {{ getAge(installed.createdAt) }}</span>
                      </div>
                    </div>
                    <div class="app-divider" />
                    <div class="d-button" v-if="mode === 'installed' && installed.status != 'Installing'">
                      <el-button
                        class="app-button"
