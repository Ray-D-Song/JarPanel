<template>
  ...
  >
    ...
    <el-form ref="formRef" :model="form" label-position="top">
      ...
      <el-form-item v-if="form.isCustom" :label="$t('container.command')" prop="command" :rules="Rules.requiredInput">
      ...
      <el-form-item v-if="!form.isCustom" :label="$t('container.command')" prop="command" :rules="Rules.requiredSelect">
        <el-checkbox style="width: 100px" border v-model="form.isCustom" @change="onChangeCommand">
          {{ $t('container.custom') }}
        </el-checkbox>
      ...
      <Terminal style="height: calc(100vh - 302px); margin-top: 18px" ref="terminalRef" v-if="terminalOpen"></Terminal>
    </el-form>
  </el-drawer>
</template>
