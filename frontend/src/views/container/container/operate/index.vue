      ...
      <el-row type="flex" justify="center">
        <el-col :span="22">
          <el-form-item class="mt-5" :label="$t('commons.table.name')" prop="name">
            <el-input :disabled="isFromApp(dialogData.rowData!)" clearable v-model.trim="dialogData.rowData!.name" />
          ...
          <el-form-item v-if="!dialogData.rowData!.publishAllPorts">
            <el-card class="widthClass">
              <el-table v-if="dialogData.rowData!.exposedPorts.length !== 0" :data="dialogData.rowData!.exposedPorts">
          ...
          <el-form-item :label="$t('container.network')" prop="network">
            <el-select v-model="dialogData.rowData!.network">
              <el-option v-for="(item, indexV) of networks" :key="indexV" :value="item.option" :label="item.option" />
            </el-select>
          </el-form-item>
          ...
          <el-form-item label="Command" prop="cmdStr">
            <el-input type="textarea" v-model="dialogData.rowData!.cmdStr" :placeholder="$t('container.cmdHelper')" />
          </el-form-item>
