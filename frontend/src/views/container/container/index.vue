    ...
    <LayoutContent :title="$t('container.container')" :class="{ mask: dockerStatus != 'Running' }">
      ...
      <template #main>
        ...
        >
          ...
          <el-table-column :label="$t('container.image')" show-overflow-tooltip min-width="150" prop="imageName" />
          <el-table-column :label="$t('commons.table.status')" min-width="100" prop="state" sortable>
            <template #default="{ row }">
              <Status :key="row.state" :status="row.state"></Status>
            </template>
          </el-table-column>
          <el-table-column :label="$t('container.source')" show-overflow-tooltip prop="resource" min-width="120">
            <template #default="{ row }">
          ...
          <el-table-column :label="$t('container.ip')" :width="mobile ? 80 : 'auto'" min-width="100" prop="network">
            <template #default="{ row }">
            ...
            <template #default="{ row }">
              <div>
                <el-tooltip
                  ...
                  placement="top"
                >
                  <el-button icon="Position" plain size="small" @click="router.push({ name: 'AppInstalled' })">
              ...
              <div>
                <el-tooltip
                  ...
                  class="mt-1"
                >
                  <el-button icon="Position" plain size="small" @click="router.push({ name: 'Website' })">
                    {{ $t('website.website') }}:
                    {{ row.websites.join(',') }}
                  </el-button>
                </el-tooltip>
          ...
          <el-table-column :label="$t('container.upTime')" min-width="200" show-overflow-tooltip prop="runTime" />
          <fu-table-operations
            fix
            width="180px"
            :ellipsis="2"
