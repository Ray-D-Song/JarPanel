        ...
        <el-row type="flex" justify="center">
          <el-col :span="22">
            <el-form-item :label="$t('container.tag')" prop="tagName">
              <div style="width: 100%">
                <el-checkbox v-model="deleteAll" :indeterminate="isIndeterminate" @change="handleCheckAllChange">
                  {{ $t('container.removeAll') }}
                </el-checkbox>
              </div>
              <el-checkbox-group v-model="form.deleteTags" @change="handleCheckedChange">
                <div>
                  <el-checkbox style="width: 100%" v-for="item in form.tags" :key="item" :value="item" :label="item" />
                </div>
              </el-checkbox-group>
            </el-form-item>
          </el-col>
