<template>
  <div v-loading="loading">
    ...
    <LayoutContent style="margin-top: 30px" back-name="Compose" :title="$t('container.containerList')" :reload="true">
      <template #main>
        <el-button-group>
        ...
        >
          ...
          <el-table-column :label="$t('commons.table.name')" min-width="100" prop="name" fix show-overflow-tooltip>
          ...
          />
          <fu-table-operations width="220" :ellipsis="10" :buttons="buttons" :label="$t('commons.table.operate')" fix />
        </ComplexTable>
