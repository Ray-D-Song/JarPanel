          ...
          <el-col :xs="24" :sm="24" :md="15" :lg="12" :xl="10">
            <el-form :model="form" label-position="left" :rules="rules" ref="formRef" label-width="120px">
              <el-form-item :label="$t('container.mirrors')" prop="mirrors">
                <div class="flex w-full justify-start flex-col sm:flex-row sm:items-end" v-if="form.mirrors">
                  <el-input type="textarea" :rows="5" disabled v-model="form.mirrors" class="sm:calc(100% - 80px)" />
              ...
              <el-form-item :label="$t('container.cutLog')" prop="hasLogOption">
                ...
                <div v-if="logOptionShow">
                  ...
                  <el-tag style="margin-left: 5px">{{ $t('container.maxFile') }}: {{ form.logMaxFile }}</el-tag>
                  <div>
              ...
              <el-form-item label="live-restore" prop="liveRestore">
                <el-switch :disabled="form.isSwarm" v-model="form.liveRestore" @change="handleLive"></el-switch>
    ...
    >
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button :disabled="submitInput !== $t('database.restartNow')" type="primary" @click="onSubmitCloseIPtable">
