          ...
          <div class="flex flex-wrap gap-3">
            ...
            <div>
              <el-dropdown>
                ...
                <template #dropdown>
                  <el-dropdown-menu>
                    <el-dropdown-item icon="Position" @click="goDashboard('phpMyAdmin')">phpMyAdmin</el-dropdown-item>
                    <el-dropdown-item icon="Position" @click="goDashboard('Adminer')" divided>Adminer</el-dropdown-item>
                  </el-dropdown-menu>
                </template>
              </el-dropdown>
            </div>
        ...
        >
          ...
          <el-table-column :label="$t('commons.login.username')" show-overflow-tooltip prop="username">
            <template #default="{ row }">
              ...
              <div v-else>
                <el-button :disabled="row.isDelete" style="margin-left: -3px" type="primary" link @click="onBind(row)">
                  {{ $t('database.userBind') }}
                </el-button>
              </div>
            </template>
