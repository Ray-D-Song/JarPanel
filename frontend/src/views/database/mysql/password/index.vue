            ...
            <div v-if="changeForm.operation === 'privilege'">
              <el-form-item :label="$t('database.permission')" prop="privilege">
                <el-select style="width: 100%" v-model="changeForm.privilege">
                  ...
                  <el-option v-if="changeForm.from !== 'local'" value="localhost" :label="$t('terminal.localhost')" />
...
const acceptParams = (params: DialogProps): void => {
  title.value =
    params.operation === 'password' ? i18n.global.t('database.changePassword') : i18n.global.t('database.permission');
