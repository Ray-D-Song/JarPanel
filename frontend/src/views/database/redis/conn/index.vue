        ...
        <el-col :span="22">
            ...
            <el-card class="mini-border-card">
              <el-descriptions :column="1">
                <el-descriptions-item :label="$t('database.connAddress')">
                  <el-tooltip v-if="loadRedisInfo(true).length > 48" :content="loadRedisInfo(true)" placement="top">
          ...
          <el-form-item :label="$t('database.remoteConn')">
            <el-card class="mini-border-card">
              <el-descriptions :column="1">
                <el-descriptions-item :label="$t('database.connAddress')">
                  <el-tooltip v-if="loadRedisInfo(false).length > 48" :content="loadRedisInfo(false)" placement="top">
