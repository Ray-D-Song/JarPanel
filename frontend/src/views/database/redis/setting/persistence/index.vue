  ...
  <div v-if="persistenceShow">
            ...
            <el-row>
              ...
              <el-form>
                <el-form-item label="appendonly" prop="appendonly">
                  <el-switch active-value="yes" inactive-value="no" v-model="form.appendonly"></el-switch>
                </el-form-item>
    ...
    <el-card style="margin-top: 20px">
      <ComplexTable :pagination-config="paginationConfig" v-model:selects="selects" @search="search" :data="data">
        ...
        <fu-table-operations width="300px" :buttons="buttons" :ellipsis="10" :label="$t('commons.table.operate')" fix />
      </ComplexTable>
    </el-card>
