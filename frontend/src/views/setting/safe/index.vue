<template>
  <div>
    <LayoutContent v-loading="loading" :title="$t('setting.safe')" :divider="true">
      <template #main>
        <el-form :model="form" v-loading="loading" :label-position="mobile ? 'top' : 'left'" label-width="150px">
          <el-row>
            ...
            <el-col :xs="24" :sm="20" :md="15" :lg="12" :xl="12">
              ...
              <el-form-item :label="$t('setting.panelSSL')" prop="ssl">
                <el-switch @change="handleSSL" v-model="form.ssl" active-value="enable" inactive-value="disable" />
