        ...
        <el-row :gutter="20" class="common-div">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="flx-justify-between">
              ...
              <div>
                <el-button round :disabled="s3Data.id === 0" @click="onOpenDialog('edit', 'S3', s3Data)">
                  {{ $t('commons.button.edit') }}
                </el-button>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="flx-justify-between">
              ...
              <div>
                <el-button round :disabled="ossData.id === 0" @click="onOpenDialog('edit', 'OSS', ossData)">
                  {{ $t('commons.button.edit') }}
                </el-button>
        ...
        <el-row :gutter="20" class="common-div">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="flx-justify-between">
              ...
              <div>
                <el-button round :disabled="cosData.id === 0" @click="onOpenDialog('edit', 'COS', cosData)">
                  {{ $t('commons.button.edit') }}
                </el-button>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            ...
            <el-alert v-else center class="alert" style="height: 257px" :closable="false">
              <el-button size="large" round plain type="primary" @click="onOpenDialog('create', 'OneDrive')">
        ...
        <el-row :gutter="20" style="margin-top: 20px">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="flx-justify-between">
              ...
              <div>
                <el-button round :disabled="kodoData.id === 0" @click="onOpenDialog('edit', 'KODO', kodoData)">
                  {{ $t('commons.button.edit') }}
                </el-button>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="flx-justify-between">
              ...
              <div>
                <el-button round :disabled="minioData.id === 0" @click="onOpenDialog('edit', 'MINIO', minioData)">
                  {{ $t('commons.button.edit') }}
                </el-button>
        ...
        <el-row :gutter="20" style="margin-top: 20px">
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            <div class="flx-justify-between">
              ...
              <div>
                <el-button round plain :disabled="sftpData.id === 0" @click="onOpenDialog('edit', 'SFTP', sftpData)">
                  {{ $t('commons.button.edit') }}
                </el-button>
          ...
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12">
            ...
            <el-alert v-else center class="alert" style="height: 257px" :closable="false">
              <el-button size="large" round plain type="primary" @click="onOpenDialog('create', 'WebDAV')">
