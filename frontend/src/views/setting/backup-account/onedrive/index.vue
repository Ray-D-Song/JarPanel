          ...
          <el-col :span="22">
            ...
            <el-form-item>
              ...
              <span class="input-help">
                ...
                <el-link style="font-size: 12px; margin-left: 5px" icon="Position" @click="toDoc(true)" type="primary">
            ...
            <el-form-item :label="$t('setting.code')" prop="varsJson.code" :rules="rules.driveCode">
              ...
              <span class="input-help">
                ...
                <el-link style="font-size: 12px; margin-left: 5px" icon="Position" @click="toDoc(false)" type="primary">
                  {{ $t('firewall.quickJump') }}
                </el-link>
              </span>
            </el-form-item>
