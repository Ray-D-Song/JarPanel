  ...
  <div>
    <el-card style="margin-top: 20px">
      ...
      <el-row>
        ...
        <el-col :span="10">
          <el-form :model="passForm" ref="passFormRef" :rules="passRules" label-position="left" label-width="160px">
            ...
            <el-form-item v-if="isComplexity" :label="$t('setting.newPassword')" prop="newPassComplexity">
              <el-input type="password" show-password clearable v-model.trim="passForm.newPassComplexity" />
            </el-form-item>
