    ...
    <el-row :gutter="20" style="margin-top: 20px">
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="16">
        ...
        <CardWithHeader :header="$t('menu.monitor')" style="margin-top: 20px; margin-bottom: 20px">
          <template #header-r>
            <el-radio-group style="float: right; margin-left: 5px" v-model="chartOption" @change="changeOption">
          ...
          <template #body>
            <div style="position: relative; margin-top: 20px">
              <div class="monitor-tags" v-if="chartOption === 'network'">
                <el-tag>{{ $t('monitor.up') }}: {{ computeSizeFromKBs(currentChartInfo.netBytesSent) }}</el-tag>
                <el-tag>{{ $t('monitor.down') }}: {{ computeSizeFromKBs(currentChartInfo.netBytesRecv) }}</el-tag>
