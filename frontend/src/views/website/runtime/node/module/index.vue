    ...
    <el-row :gutter="20" v-loading="loading">
      ...
      <el-col>
        <ComplexTable :data="data" @search="search()" class="mt-5" :height="800">
          ...
          <el-table-column :label="$t('commons.table.protocol')" prop="license" width="120px"></el-table-column>
          <el-table-column
...
const operateModule = (operate: string, moduleName: string) => {
  ElMessageBox.confirm(
    ...
    try {
      ...
      MsgError(
        i18n.global.t('commons.operate.' + operate) + i18n.global.t('commons.status.failed') + '  ' + error.message,
      );
    } finally {
      loading.value = false;
    }
