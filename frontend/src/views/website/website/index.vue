  ...
  <div>
    ...
    <LayoutContent :title="$t('website.website')" v-loading="loading">
      ...
      <template v-if="nginxIsExist && !openNginxConfig" #toolbar>
        <div class="flex justify-between gap-2 flex-wrap sm:flex-row" :class="{ mask: nginxStatus != 'Running' }">
      ...
      <template v-if="nginxIsExist && !openNginxConfig" #main>
        ...
        >
          ...
          <el-table-column
            ...
            min-width="120px"
          ></el-table-column>
          <el-table-column :label="$t('commons.table.protocol')" prop="protocol" width="90px"></el-table-column>
          <el-table-column :label="$t('website.expireDate')" prop="expireDate" :sortable="'custom'" min-width="120px">
            <template #default="{ row }">
