      ...
      <el-col :span="22" :offset="1">
        ...
        >
          ...
          <div v-if="website.type === 'deployment'">
            ...
            <el-form-item v-if="website.appType == 'installed'" :label="$t('website.appInstalled')" prop="appInstallId">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="16">
                <el-form-item :label="$t('runtime.runtime')" prop="runtimeID">
                  <el-select v-model="website.runtimeID" @change="changeRuntime(website.runtimeID)" filterable>
                    <el-option
          ...
          <div v-if="website.appinstall.advanced">
            ...
            <el-form-item :label="$t('container.cpuQuota')" prop="appinstall.cpuQuota">
              <el-input type="number" style="width: 40%" v-model.number="website.appinstall.cpuQuota" maxlength="5">
            ...
            <el-form-item :label="$t('container.memoryLimit')" prop="appinstall.memoryLimit">
              <el-input style="width: 40%" v-model.number="website.appinstall.memoryLimit" maxlength="10">
                <template #append>
                  <el-select v-model="website.appinstall.memoryUnit" placeholder="Select" class="pre-select">
          ...
          <el-form-item prop="enableFtp" v-if="website.type === 'static' || website.type === 'runtime'">
            <el-checkbox @change="random" v-model="website.enableFtp" :label="$t('website.enableFtp')" size="large" />
