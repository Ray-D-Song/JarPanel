    ...
    <LayoutContent :title="$t('website.ssl')">
      ...
      <template #main>
        ...
        >
          ...
          ></el-table-column>
          <el-table-column :label="$t('commons.table.status')" fix show-overflow-tooltip prop="status" width="100px">
            <template #default="{ row }">
              <el-popover
                v-if="row.status === 'error' || row.status === 'applyError' || row.status === 'systemRestart'"
                placement="bottom"
                :width="400"
                trigger="hover"
              >
          ...
          <el-table-column :label="$t('website.brand')" fix show-overflow-tooltip prop="organization"></el-table-column>
